    ...
    xhr.send(
      ...
      #docs-root[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./components_combined","files":"**/*.stories.js","importPathMatcher":"^\\.[\\\\/](?:components_combined(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)\\/|\\/|$)(?!\\.)(?=.)[^/]*?\\.stories\\.js)$"}];
          
      
          
            window['SERVER_CHANNEL_URL'] = "ws://localhost:60708/storybook-server-channel";</script><script src="runtime~main.iframe.bundle.js"></script><script src="vendors~main.iframe.bundle.js"></script><script src="main.iframe.bundle.js"></script></body></html>