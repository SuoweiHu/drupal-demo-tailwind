    ...
    value: function generateAnnouncers() {
      this.announcers = {
        ...
        link: function link(element) {
          this.say("Link, ".concat(computeAccessibleName(element), ". To follow the link, press Enter key."));
        },
        button: function button(element) {
          this.say("Button, ".concat(computeAccessibleName(element), ". To press the button, press Space key."));
        },
        heading: function heading(element) {
          var level = element.getAttribute('aria-level') || element.tagName[1];
          this.say("Heading level ".concat(level, ", ").concat(computeAccessibleName(element)));
        },
        paragraph: function paragraph(element) {
          this.say(element.textContent);
        },
        image: function image(element) {
          this.say("Image, ".concat(computeAccessibleName(element)));
        },
        "default": function _default(element) {
          this.say("".concat(element.tagName, " element: ").concat(computeAccessibleName(element)));
        }
      };
    }
  }, {
